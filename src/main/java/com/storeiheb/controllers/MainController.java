...
package com.storeiheb.controllers;
...
import com.storeiheb.daos.CategoryRepository;
import com.storeiheb.daos.CommentRepository;
import com.storeiheb.daos.ProductRepository;
import com.storeiheb.daos.UnbanRequestRepository;
import com.storeiheb.daos.UserRepository;
import com.storeiheb.entities.Category;
import com.storeiheb.entities.Comment;
import com.storeiheb.entities.Product;
...
public class MainController {
	...
	public String firstHomeView(Model m, Principal principal) {
		...
		m.addAttribute("title", "StoreIheb | Start Shopping Now!");
	...
	public String registerPage(Model m) {
		...
		m.addAttribute("title", "Register | StoreIheb");
	...
	public String loginPage(Model m) {
		...
		m.addAttribute("title", "Login | StoreIheb");
		return "login";
	}
	...
	public String unbanRequestView(Model m) {
		m.addAttribute("title", "Unban Request | StoreIheb");
	...
	*/
	...
	public String showProfile(Model m, Principal principal, HttpSession httpSession) {
		...
		m.addAttribute("title", user.getName() + " | StoreIheb");
		m.addAttribute("user", user);
		return "profile";
	}
	...
	public String checkOut(Model m, Principal principal, HttpSession httpSession) {
		...
		m.addAttribute("title", "Checkout | StoreIheb");
		return "checkout";
	}
